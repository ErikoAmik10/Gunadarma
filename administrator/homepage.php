...
<head>
  ...
  <title>Universitas Gunadarma .: Dashboard Administrator :.</title>
  <link rel="icon" href="foto/ut.png">
  <!-- Theme style -->
  <link rel="shortcut icon" href="foto/ug.png">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="homepage.php?p=bimbingan_skripsi"><i class="fa fa-desktop"></i><span>Monitoring</span></a>
          </li>
          <li>
