                ...
                <div class="col-md-8">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-footer">
                            <button type="submit" name="simpan" class="btn btn-success"><i class="fa fa-check"></i> Save</button>
                        <a class="btn btn-warning" href="homepage.php?p=data_dosen"><i class="fa fa-mail-reply"></i> Cancel </a>
                    </div>
                    </form>
                    <?php
                        $x1 = trim ($_POST['nidn']);
