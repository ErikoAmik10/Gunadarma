...
<head>
  ...
  <title>Universitas Gunadarma  .: Dashboard Dosen:.</title>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="homepage.php?p=bimbingan_skripsi"><i class="fa fa-pencil"></i><span>Bimbingan Skripsi</span></a>
          </li> 
          <li>
            <a href="homepage.php?p=jumlah_mhs">
              <i class="fa fa-users"></i><span>Mahasiswa Bimbingan</span></a>
          </li>
          <li><a href="homepage.php?p=skripsi"><i class="fa fa-check-square"></i><span>Pengecekkan</span></a></li> 
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li>
                <a href="homepage.php?p=persetujuan_skripsiterima"><i class="fa fa-circle-o"></i>Skripsi Yang Diterima</a></li>
              <li><a href="homepage.php?p=persetujuan_skripsitolak"><i class="fa fa-circle-o"></i>Skripsi Yang Ditolak</a>
              </li>
            </ul>
          </li> 
          <li>
