                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="file" name="file" value="<?php echo $nama_file;?>" readonly>
                                <td>
                                <a href="../dosen/file/<?php echo $data[file]; ?>" class='btn btn-xs btn-warning' title='View Document' target="_blank"><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span> View</a>
                                </td>
                            </div> -->
                            <!-- /.box-body -->
