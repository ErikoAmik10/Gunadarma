                ...
                <div class="col-md-8">
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <!-- form judul laporan-->
                            <div class="form-group">
                                <label>Aktivitas <h5>(Isi informasi atau keterangan apa yang ingin disampaikan)</h5></label>
                                <textarea class="form-control" name="aktivitas" rows="3" placeholder="Isi aktivitas/catatan yang Anda lakukan" required></textarea>
                                <p class="help-block">*Misal: Pengajuan Bab I atau Revisi Bab I"</p>
                            </div>
                            <!-- form jenis laporan-->
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenis_laporan" required>
                                    ...
                                    <option value="skripsi">Pengajuan Baru</option>
                                    <option value="skripsi">Revisi Skripsi</option>
                                </select>
                            </div>
                            <!-- form file laporan-->
                            <div class="form-group">
                                ...
                                <p class="help-block">format laporan (doc/pdf): namamahasiswa_babskripsi</p>
                            </div>
                        <!-- /.box-body -->
